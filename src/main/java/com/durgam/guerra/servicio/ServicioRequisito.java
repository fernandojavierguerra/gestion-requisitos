...
public class ServicioRequisito {
	...
	public void grabarRequisito(Requisito requisito) {
		...
		// Proyecto proyecto =
		// servicioProyecto.buscarProyectoPorId(requisito.getId());
		if (requisito.getId() == null) {

			// Agregar nuevo requisito con proyecto
			// gestionRequisito=servicioGestionRequisito.agregarProyecto(gestionRequisito,
			// proyecto);
	...
	@Transactional
	public void agregarRequisitoSimpleaCompuesto(RequisitoSimple requisitoSimple,
			RequisitoCompuesto requisitoCompuesto) {
